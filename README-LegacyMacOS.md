...
This will guide you on the process of installing Trunk-Recorder and Trunk-Player on MacOS. It is specific to setting up a LibreSDR device on the on the MPSCS but can be customized for other radio / systems. 
